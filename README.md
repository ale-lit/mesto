...
Добавлена возможность добавления новых фотографий с описаниями пользователями, удаление ранее добавленных карточек, а также возможность ставить отметку "Нравится" у понравившихся фотографий (пока без сохранения изменений на сервере).
